...
async def next_page(bot, query):
    ...
    btn.insert(0, 
        [
            ...
            InlineKeyboardButton('sʜᴀʀᴇ ᴍᴇ', url="Hi+my+friend%2C%0D%0AThis+group+has+all+movies%2C++just+type+and+get+all+movies%2C++join+and+enjoy+%E2%9D%A4%EF%B8%8F%E2%80%8D%F0%9F%94%A5.%0D%0AJoin+here+%F0%9F%91%87.%0D%0Ahttps%3A%2F%2Ft.me%2F%2B0VeQ6Wrq1elkOTkx%0D%0Ahttps%3A%2F%2Ft.me%2F%2B0VeQ6Wrq1elkOTkx%0D%0Ahttps%3A%2F%2Ft.me%2F%2B0VeQ6Wrq1elkOTkx%0D%0A%0D%0A%40TrockersLinks"),
...
async def advantage_spoll_choker(bot, query):
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit("<b>💌 ᴛʜɪs ᴍᴏᴠɪᴇ ɪs ɴᴏᴛ ʏᴇᴛ ʀᴇʟᴇᴀsᴇᴅ ᴏʀ ᴀᴅᴅᴇᴅ ᴛᴏ ᴍʏ ᴅᴀᴛᴀʙᴀsᴇ 💌</b>\n› <a href=https://t.me/Sky_Movies_linkzz><b>ᴄʜᴇᴄᴋ ɪɴ ᴛʜɪꜱ ᴄʜᴀɴɴᴇʟ</b></a>", disable_web_page_preview=True)
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        await query.answer("Contact him to get bot like me")
        buttons = [[
            InlineKeyboardButton('👀ᴍᴀɪɴ ᴍᴇɴᴜ👀', callback_data='start')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
